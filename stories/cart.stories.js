...
export const emptyCart = (args) => Cart(args);

emptyCart.args = {
    clearButton: new ButtonIcon({
    ...
    orderButton: new Button({
        ...
        color: 'black',
        size: 'md',
        classes: ['cart__buy-button'],
    }).render(),
    deliveryTimeText: Fonts({
        text: 'Время доставки',
        classes: ['font_h3'],
    })
}

export const cart = (args) => Cart(args);
cart.args = {
    restaurant: {
        name: 'Вова Путин',
