import {SortHeader} from "../src/components/sortHeader/sortHeader";
import {ButtonIconV} from "../src/components/button/button";

export default {
  title: "Components/SortHeader",
  component: SortHeader,
}

export const sortHeader = (args) => {
  return new SortHeader(args).render();
}

const icon = '<svg class="button-icon-v__icon sort-underheader__button-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="528" height="528" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve">\n' +
  '<g>\n' +
