import {ProfileButtonsNav} from "../src/components/profileButtonsNav/profileButtonsNav.js";
import {Button} from "../src/components/button/button";

export default {
    title: "Components/ProfileButtonsNav",
    component: ProfileButtonsNav,
}

export const profileButtonsNav = (args) => ProfileButtonsNav(args);

profileButtonsNav.args = {
    buttons: [
        new Button({
            label: 'Адреса',
            color: "transparent",
            rounded: false,
            size: "md",
            icon: '<svg style="width: 1em; height: 1em;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">\n' +
                '            <path d="M512 1024C229.229714 1024 0 794.770286 0 512 0 229.229714 229.229714 0 512 0 794.770286 0 1024 229.229714 1024 512 1024 794.770286 794.770286 1024 512 1024ZM404.21181 404.21181 229.059048 794.940952 619.78819 619.78819 794.940952 229.059048 404.21181 404.21181ZM444.635429 444.635429 579.364571 579.364571 323.364571 700.635429 444.635429 444.635429Z">\n' +
                '\n' +
                '            </path>\n' +
                '        </svg>'
        }).render(),
